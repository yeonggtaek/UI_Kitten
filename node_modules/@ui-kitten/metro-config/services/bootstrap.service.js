...
class BootstrapService {
    ...
    static ensureEvaPackagesInstalledOrWarn = () => {
    ...
    static processMappingIfNeeded = (config) => {
        ...
        if (actualChecksum === DEFAULT_CHECKSUM || actualChecksum !== nextChecksum) {
            const mapping = (0, lodash_merge_1.default)({}, evaMapping, customMapping);
    ...
    static createWritableCache = (checksum, styles) => {
        const cache = {
            checksum,
            styles,
        };
